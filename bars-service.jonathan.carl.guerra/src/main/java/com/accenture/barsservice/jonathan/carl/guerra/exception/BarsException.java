package com.accenture.barsservice.jonathan.carl.guerra.exception;
...
public class BarsException extends RuntimeException {
	...
	public static final String INVALID_BILLLING_CYCLE = 
	...
	public BarsException(String message, Throwable err) {
		super(message, err);
	}
